...
# --- FILE AND ARGUMENT SETUP ---
HVG_FILENAME="astro_exc1_exc2_exc3_immune_inhi_oligo_opcs_vasc_ntop_8000_common_1111.txt"
...
time python3 preprocess_pipeline_pseudobulk_common_hvgs.py "$HVG_FILENAME" "$SLURM_ARRAY_TASK_ID"
