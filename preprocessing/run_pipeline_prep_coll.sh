#!/bin/bash
#SBATCH --job-name=prep_collection
...
#SBATCH --output=logs/%A_%a_prep_collection.out
# This captures errors in a separate file for quicker debugging
#SBATCH --error=logs/%A_%a_prep_collection.err
...
time python3 -u pipeline_prep_collection.py 0 1 2 3 4 5 6 7 8
