#!/bin/bash
#SBATCH --job-name=preprocessing_hvg_non_pseudo
...
#SBATCH --output=logs/%A_%a_preproc_hvg_non_pseudo.out
# This captures errors in a separate file for quicker debugging
#SBATCH --error=logs/%A_%a_preproc_hvg_non_pseudo.err
...
time python3 -u pipeline_preprocess_hvg_non_pseudo.py $SLURM_ARRAY_TASK_ID --draw_umaps False
